        ...
        <div className="w-full max-w-md sm:max-w-lg">
          <div className="rounded-[10px] border border-white bg-white shadow-[0_0_2px_0_rgba(23,26,31,0.12),0_0_1px_0_rgba(23,26,31,0.07)] p-6 sm:p-8 xl:p-10">
            ...
            <div className="mb-6 text-center sm:mb-8">
              <h2 className="mb-2 font-open-sans text-xl font-bold text-sis-dark-text sm:mb-3 sm:text-2xl xl:text-[30px] xl:leading-9">Redefinir Senha</h2>
              <p className="font-roboto text-sm text-sis-secondary-text sm:text-base xl:leading-6">Digite sua nova senha abaixo.</p>
            </div>
